    ...
    if(isset($_POST['submit'])){
        ...
        if($uploadok == 0){
            ...
            if(move_uploaded_file($_FILES["filetoUpload"]["tmp_name"], $target_file)){
                ...
                $query = "INSERT INTO product (productname, urlimage , price , delprice) VALUE ('$name','$path','$price','$delprice')";
        ...
        <div class="main_container">
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="form-login" id="form-1" method="POST"  enctype="multipart/form-data">
                <div class="form-header">
                    <h3 class="form-heading">Add Product</h3>
                </div>
                <div class="form-group">
                    <label for="name" class="form-label">Tên sản phẩm</label>
                    <input id="name" name="name" type="text" placeholder="VD: Đồng hồ"
                        class="form-control1">
                ...
                <div class="form-group">
                    ...
                    <input id="price" name="price" type="number" placeholder="VD: 120" class="form-control1">
                    <i class="fa-solid fa-money-bill form-user"></i>
                    <span class="form-message"></span>
                </div>
                <div class="form-group">
                    <label for="name" class="form-label">Giá bán cũ</label>
                    <input id="delprice" name="delprice" type="number" placeholder="VD: 140" class="form-control1">
                    <i class="fa-solid fa-money-bill form-user"></i>
                    <span class="form-message"></span>
                </div>
                <div class="form-group">
