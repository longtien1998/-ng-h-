...
<head>
    ...
    <!-- <link rel="stylesheet" href="../backend/connect.php"> -->
                        ...
                        <nav class="navbar navbar-expand-lg bg-gray-900 navbar-light py-3 py-lg-0 px-0">
                            ...
                            <div class="collapse navbar-collapse" id="navbarCollapse">
                                <div class="navbar-nav mr-auto py-0 w-100 d-flex justify-content-center">
                                    <a href="home.php" class="nav-item nav-link position-relative text-uppercase mx-4 active">Home</a>
                ...
                echo '<div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4" data-index="'.$i.'">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="product-thumbnail img-fluid w-100" src="' . $row['urlimage'] . '" alt="">
            ...
            <div class="row justify-content-md-center py-5 ">
                <div class="col-md-6 col-12 py-5">
                    <div class="text-center mb-2 pb-2">
                        ...
                        <p class="text-light">Amet lorem at rebum amet dolores. Elitr lorem dolor sed amet diam labore
                            at justo ipsum eirmod duo labore labore.</p>
                    </div>
                    <form action="">
            ...
            <div class="row  pt-5">
                <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                    <a href="" class="text-decoration-none">
                        <h2 class="mb-4 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border border-white px-3 mr-1">FrifayShopping</span>
                        </h2>
                    </a>
                                ...
                                <div class="form_button_details margin-top-15 w-100">
                                    <div class="form_product_content type1 ">
                                        ...
                                        <div class="button_actions clearfix" style="grid-template-columns:1fr 1fr ">
                                            <div class="card-footer d-flex justify-content-between bg-light border">
                                                <a type="button" class="btn btn-sm btn-add-cart text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add to
                                                    cart</a>
                                            </div>
                                        </div>
                                    </div>
