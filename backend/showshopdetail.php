...
<body>
                        ...
                        <nav class="navbar navbar-expand-lg bg-gray-900 navbar-light py-3 py-lg-0 px-0">
                            ...
                            <div class="collapse navbar-collapse" id="navbarCollapse">
                                <div class="navbar-nav mr-auto py-0 w-100 d-flex justify-content-center">
                                    ...
                                    <a href="showshopdetail.php" class="nav-item nav-link position-relative text-uppercase  mx-4 active">Show Shop Detail</a>
    ...
    <div class="container-fluid bg-gray-200 mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 200px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">List Product</h1>
            <div class="d-inline-flex">
                <p class="m-0"><a href="">Home</a></p>
                <p class="m-0 px-2">-</p>
                <p class="m-0">List Product</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
            ...
            <table class="table table-bordered table-striped table-hover">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th scope="col" style="width: 100px;">Delprice</th>
                ...
                <tbody>
                    <?php
                        ...
                        while ($row = mysqli_fetch_assoc($result)){
                            ...
                            echo "<td><img src=".$row['urlimage']."></td>";
                            echo '<td style="width: 100px;">';
                            echo " <a href='update-img.php?id=" . $row['id'] ."'>Sửa</a>";
                            echo "</td>";
                            echo '<td style="width: 100px;">';
